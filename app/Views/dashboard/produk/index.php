            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="tabel-produk" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                      <?php $i = 1; $z = 0; $ukuran = ""; foreach($produk as $produk) : ?>
                        <?php 
                        ...
                        <tr>
                            ...
                            <td><?= $ukuran ?></td>
                            <td><button class="openDeskripsi btn btn-primary" data-toggle="modal" data-target="#deskripsiModal" data-deskripsi="<?= $produk['produk']['deskripsi'] ?>"><i class="fas fa-sticky-note"></i></button></td>
                            <td><button class="openGambar btn btn-primary" data-toggle="modal" data-target="#fotoModal" data-alamatgambar="<?= $produk['produk']['gambar'] ?>"><i class="fas fa-image"></i></button></td>
                            <td>
                                <a href="<?= base_url('dashboard/produk/edit/'.$produk['produk']['url_slug']) ?> " class="btn btn-success"><i class="fas fa-edit"></i></a>  <!-- tambahin /kodeproduk -->
                                <button class="deleteProduct btn btn-danger" data-toggle="modal" data-target="#deleteModal" data-id="<?= $produk['produk']['id'] ?>"><i class="fas fa-trash-alt"></i></button>
                            </td>
                        </tr>
